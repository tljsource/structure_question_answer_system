...
<html lang="en">
    ...
    <?php
        ...
        #将答案插入数据库中
        $sql1 = "INSERT INTO `faq`(`question`, `answer`) VALUES";
    ?>
        <!-- Top content -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-9 col-sm-offset-2 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="TF_IDF_answer.php" method="post" class="login-form">
                                    <div class="form-group">
                                        ...
                                        <label style="margin-top: 2%;">
                                            ...
                                            if($length_file && $flag){
                                                ...
                                                echo "<script>alert('查询失败');location.href='TF_IDF.php';</script>";
                                            }
                                            ?>    
                                            </p>
                                        </label>
