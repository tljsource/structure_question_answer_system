...
<html lang="en">
    ...
    <?php
        ...
        $filepath = "F:\wamp\www\structure_question_answering\\relation_extractor\\relation_predict.txt";
        set_time_limit(0);
        #防止php调用Python出现中文乱码
        $locale='en_US.UTF-8';
                            ...
                            <div class="form-bottom">
                                <form role="form" action="answer.php" method="post" class="login-form">
                                    <div class="form-group">
                                        <textarea cols='100' style='margin-top:2%;height:200px;' type="text" class="form-username form-control" ><?php echo $content; ?></textarea>
                                    </div>
                                </form>
                            </div>
                        </div>
