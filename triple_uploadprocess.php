...
<?php  
    ...
    if(is_uploaded_file($_FILES['myfile']['tmp_name'])) {  
        ...
        //我们给每个用户动态的创建一个文件夹  
        $user_path=$_SERVER['DOCUMENT_ROOT']."/structure_question_answering/upload_triple_file/";  
        //判断该用户文件夹是否已经有这个文件夹  
        ...
        if(move_uploaded_file($uploaded_file,iconv("utf-8","gb2312",$move_to_file))) {  
            ...
            $file_train = fopen('F:\wamp\www\structure_question_answering\upload_train_relation\origin_data\train.txt', 'a+');
            fwrite($file_train, "\r\n".$content);
