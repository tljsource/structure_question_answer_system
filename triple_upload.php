                        ...
                        <div class="col-sm-9 col-sm-offset-2 form-box">
                        	<div class="form-bottom">
                        		<div class="form-top-left">
                            		<h3 style="margin-left: 50%;">实体关系对文件上传</h3>
                                    <p style="margin-left: 20%;">说明：实体1（Tab）实体2（Tab）关系（Tab）包含实体对的语句
                        		</div>
                            ...
                            <div class="form-bottom">
                            <form enctype="multipart/form-data" method="post" action="triple_uploadprocess.php" class="login-form">  
                            <label style="margin-left: 20%;color: blue;">请上传txt文件</label>
