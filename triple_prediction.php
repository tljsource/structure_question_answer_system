                        ...
                        <div class="col-sm-9 col-sm-offset-2 form-box">
                        	<div class="form-bottom">
                        		<div class="form-top-left">
                            		<h3 style="margin-left: 50%;">文本上传</h3>
                                    <p style="margin-left: 20%;">说明：上传的纯文本用来抽取语句中的三元组
                        		</div>
                            ...
                            <div class="form-bottom">
                            <form enctype="multipart/form-data" method="post" action="prediction_process.php" class="login-form">  
